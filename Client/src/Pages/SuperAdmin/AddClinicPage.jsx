...
const AddClinicPage = () => {
    ...
    return (
        <>
            <HomeLayout>
                <div className="flex flex-col justify-center items-center m-auto p-10">
                    <h1 className="text-2xl font-bold text-gray-800 mb-6">Add Clinic</h1>

                    <div className="w-full max-w-md bg-white shadow-md rounded-xl p-6">
                        <div className="flex flex-col items-center mb-4">
                            <label className="cursor-pointer">
                                <input type="file" onChange={handleImageChange} hidden />
                                <div className="w-24 h-24 border-2 border-dashed rounded-full flex items-center justify-center overflow-hidden">
                                    <img
                                        src={
